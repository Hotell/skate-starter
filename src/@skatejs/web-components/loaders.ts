...
function loadAdapter(useAdapter = true) {
  return useAdapter && window.customElements
    ? import(// tslint:disable-next-line:max-line-length
      ...
      /* webpackChunkName: "es5-adapter" */ '@webcomponents/webcomponentsjs/custom-elements-es5-adapter')
    : Promise.resolve()
}
...
function loadES6requiredPolyfills() {
  return Promise.all([
    import(// tslint:disable:whitespace
    /* webpackChunkName: "es6-with-template-polyfills" */ '@webcomponents/template'),
